...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    yeoman: {
      ...
      images: 'images',
      dist: 'www',
      phonegap: '../rtone-contrib-phonegapbuild'
    },

    sass: {
      dist: {
        files: {
          '<%= yeoman.dist %>/<%= yeoman.styles %>/ionic.inemotion.css' : 'scss/inemotion.scss'
        }
      }
    },
    ...
    compress: {
      phonegap: {
        options: {
          archive: 'www/src-phonegap.zip'
        },
        files: [
          {src: ['wwww/**'], dest: 'wwww/', filter: 'isFile'},
    ...
    rename: {
      phonegap: {
        files: [
          {src: ['www/config-pg.xml'], dest: 'www/config.xml'}
        ]
      }
    },
    concurrent: {
